...
<template>
    <div class=":uno: relative grow bg-dark-800 py-14 <md:(py-4)">
        <div class=":uno: mb-4 px-4">
            <div class=":uno: mx-a max-w-854px w-full flex flex-col">
                <div class=":uno: flex flex-col overflow-clip border border-dark-300 rounded-xl bg-dark-600 shadow-sm divide-y divide-dark-300">
                    ...
                    <div class=":uno: px-4 py-4 text-sm">
                        <div class=":uno: flex flex-col">
                            ...
                            <Collapse :base-height="80" :when="isTaskDescriptionExpanded" class=":uno: flex flex-col text-sm text-gray-400 data-[collapse='collapsed']:([mask:linear-gradient(0deg,rgba(0,0,0,0)_0%,rgba(0,0,0,1)_80%)]) space-y-5">
                                <p>
                                    Create a 2D arena with downward gravity where there will be a ball that is spawned at a random height below the roof of the arena on the click of a button and gets
                                    a
                                    small
                                    random
                                    horizontal force. The floor should have a dampening effect such that the ball eventually will come to a halt after hitting the floor multiple times. The side walls
                                    and
                                    the
                                    roof
                                    are
                            ...
                            <button class=":uno: mt-3 flex cursor-pointer items-center gap-x-2 bg-transparent text-sm text-teal-600 outline-none transition hover:(text-teal-700)" @click="isTaskDescriptionExpanded = !isTaskDescriptionExpanded">
                                Show more
                            </button>
                        </div>
        ...
        <div class=":uno: mt-4 px-4">
            <div class=":uno: mx-a max-w-854px w-full flex flex-col gap-y-4">
                ...
                <div class=":uno: flex flex-col gap-4 md:(flex-row)">
                    <div class=":uno: shrink-0 md:(sticky top-4 min-w-70 self-start)">
